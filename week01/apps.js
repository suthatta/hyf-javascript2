...
let myBooks = function (id, title, language, author) {
  this.id = id;
  this.title = title,
...
let book09 = new myBooks("book09", "baby_massage", "swedish", "george_r._r._martin")
let book10 = new myBooks("book10", "svenska_kok_book", "swedish", "george_r._r._martin")
...
let booksCover = {
  ...
  book03: {
    link: "https://image.bokus.com/images/9789174290936_200x_doktor-glas_pocket",
    title: 'doctor_glas'
  },
  book04: {
...
//create function display the cover book
